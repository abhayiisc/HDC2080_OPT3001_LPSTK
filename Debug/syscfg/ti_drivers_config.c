...
GPIO_PinConfig gpioPinConfigs[] = {
    ...
    /* CONFIG_GPIO_HDC2080_INTERRUPT : HDC2080 Interrupt */
    GPIOCC26XX_DIO_25 | GPIO_CFG_IN_PU | GPIO_CFG_IN_INT_FALLING,
    /* CONFIG_GPIO_HDC2080_POWER : HDC2080 Power */
    GPIOCC26XX_DIO_24 | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_HIGH | GPIO_CFG_OUT_LOW,
...
const uint_least8_t CONFIG_GPIO_HDC2080_INTERRUPT_CONST = CONFIG_GPIO_HDC2080_INTERRUPT;
const uint_least8_t CONFIG_GPIO_HDC2080_POWER_CONST = CONFIG_GPIO_HDC2080_POWER;
...
const I2C_Config I2C_config[CONFIG_I2C_COUNT] = {
    ...
    /* BAS Sensors Mark II I2C */
    {
        .object      = &i2cCC26xxObjects[CONFIG_I2C_SENSORS],
        .hwAttrs     = &i2cCC26xxHWAttrs[CONFIG_I2C_SENSORS]
    },
};

const uint_least8_t CONFIG_I2C_SENSORS_CONST = CONFIG_I2C_SENSORS;
...
const PIN_Config BoardGpioInitTable[CONFIG_PIN_COUNT + 1] = {
    ...
    CONFIG_PIN_7 | PIN_INPUT_EN | PIN_PULLUP | PIN_IRQ_DIS,
